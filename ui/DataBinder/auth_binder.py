...
class AuthBinder:
    ...
    def login(self, username: str, password: str) -> tuple[bool, str, str, int]:
        ...
        try:
            ...
            return True, data.get("username", username), "", int(data.get("root_folder_id", 0))
        except json.JSONDecodeError:
            return True, username, "", 0

    def register(self, username: str, password: str, confirm: str) -> tuple[bool, str, str, int]:
        username = username.strip()
        ...
        return True, data.get("username", username), "", root_id
